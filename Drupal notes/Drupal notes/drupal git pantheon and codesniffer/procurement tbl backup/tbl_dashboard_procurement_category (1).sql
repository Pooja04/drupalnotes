...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2016 at 02:19 PM
...
(3, 'Combined Low Dose OC Pills', 1),
(4, 'Emergency Contraceptive', 1),
(5, 'Female Condoms', 1),
(6, 'Injectable Contraceptives', 1),
(7, 'Intrauterine Device (IUD)', 1),
(8, 'Laboratory Testing', 1),
(9, 'Lubricants', 1),
(10, 'Male Condoms', 1),
(11, 'Progestogen only Pills', 1),
(12, 'Sampling/inspection of condoms', 1),
(13, 'Subdermal Implants', 1),
